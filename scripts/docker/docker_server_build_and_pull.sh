...
ssh -p 65001 root@80.242.58.161 'docker pull niksob/vk-bot:config-service-1.0.0'
ssh -p 65001 root@80.242.58.161 'docker pull niksob/vk-bot:quoting-service-2.0.0'
